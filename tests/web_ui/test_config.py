...
class TestWebUIConfig:
    ...
    def test_config_validates_required_environment_variables(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            ...
            assert "OPENAI_API_BASE" in validation_result.missing_vars
            assert "OPENAI_API_KEY" in validation_result.missing_vars
            assert "KBG_OLLAMA_MODEL" in validation_result.missing_vars
    ...
    def test_config_validates_with_all_required_variables(self):
        ...
        with patch.dict(os.environ, required_env, clear=True):
            ...
            assert len(validation_result.missing_vars) == 0
    ...
    def test_config_handles_invalid_temperature(self):
        """Test that config handles invalid temperature values."""
